...
- [ ] ghost module randomly spawns at 0,0 (because when the ghost is created and ready for render it doesnt take the mouse coords since the mouse didnt move yet)
...
- [ ] when i right clicked in the grid the menu should disappear
